...
const init =()=>{
    ...
    // add timer
    // setTimeout(callback funtion, time in ms)
...
const hasGameEnded =()=>{
    ...
    return hitLeftWall || hitRightWall || hitLeftWall || hitBottomWall
}
...
const drawFood =()=>{
    ...
    snakeBoardCtx.strokeStyle = ('green')
